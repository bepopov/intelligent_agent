...
public class Course   {
  ...
  /**
   * URI курса = [URI онтологии]#course[UUID]
   * @return id
  */
  @ApiModelProperty(example = "4daa9121-a1cb-416c-840a-7d793e12101f", value = "URI курса = [URI онтологии]#course[UUID]")
   ...
   * @return name
  */
  @ApiModelProperty(example = "Философия", value = "")
