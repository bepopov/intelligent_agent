...
public interface InstitutesApi {
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Курс успешно создан", response = CreateCourse.class) })
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"educationPlan\" : \"4daa9121-a1cb-416c-840a-7d793e12101f\",  \"topics\" : {    \"items\" : [ {      \"name\" : \"Тема 1. Философия в ряду других форм духовного освоения мира человеком\",      \"id\" : \"4daa9121-a1cb-416c-840a-7d793e12101f\"    }, {      \"name\" : \"Тема 1. Философия в ряду других форм духовного освоения мира человеком\",      \"id\" : \"4daa9121-a1cb-416c-840a-7d793e12101f\"    } ]  },  \"name\" : \"Философия\",  \"topicDescriptions\" : {    \"items\" : [ {      \"name\" : \"Бла-бла-бла\",      \"id\" : \"4daa9121-a1cb-416c-840a-7d793e12101f\"    }, {      \"name\" : \"Бла-бла-бла\",      \"id\" : \"4daa9121-a1cb-416c-840a-7d793e12101f\"    } ]  }}");
                    break;
                }
            }
        });
