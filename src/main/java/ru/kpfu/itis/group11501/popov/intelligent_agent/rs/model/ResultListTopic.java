...
public class ResultListTopic   {
  ...
  public ResultListTopic items(List<Topic> items) {
    this.items = items;
    return this;
  }

  public ResultListTopic addItemsItem(Topic itemsItem) {
    if (this.items == null) {
  ...
  */
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResultListTopic resultListTopic = (ResultListTopic) o;
    return Objects.equals(this.items, resultListTopic.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResultListTopic {\n");
